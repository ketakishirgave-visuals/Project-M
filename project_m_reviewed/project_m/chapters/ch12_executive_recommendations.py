...
RECOMMENDATIONS = [
    ...
    {
        "title": "Reduce allocation to Aggressive Expiry Converters",
    ...
    {
        "title": "Monitor the top 10% of cashback consumers as a concentration risk, not a targeting segment",
        "body": "This group consumes 17.3% of total cashback against 9.3% of total profit — a share of incentive roughly 1.9× its share of profit contribution (Block 7). This is a distribution pattern to monitor over time, not a basis on its own for excluding or targeting specific users without further segmentation.",
