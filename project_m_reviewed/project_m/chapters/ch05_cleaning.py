...
def render(data, skim_mode):
    ...
    if not skim_mode:
        ...
        # Display your single image containing the 3 charts
        st.image("outputs/operational_outlier_matrix.png", caption="Visualizing Outliers: Structural Nulls, Expirations, and Archetype Overlap")
        
        # Use an expander for the qualitative analysis since there is no validation script
        st.markdown("### 🔍 Analysis: Why These Distributions are Kept As-Is")
        ...
        with col1:
            ...
            st.info(
                ...
                "**📊 Impact:**\n"
                "Highly motivated traffic that keeps Daily Active User (DAU) metrics exceptionally strong."
            )
        ...
        with col2:
            ...
            st.info(
                ...
                "**The Business Reality:**\n"
                "Proof that financial guardrails are working. Our scratch-card campaign utilizes an exponential reward curve, "
