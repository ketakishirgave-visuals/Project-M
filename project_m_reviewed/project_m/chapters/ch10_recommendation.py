...
ACTIONS = [
    ...
    },
    {
        ...
        "action": "Hold current allocation, these users are timing-responsive, not amount-responsive",
        "rationale": "Maintaining is the margin-safe choice; do not reduce. Revisit if expiry window policy changes",
        "color": "#7C8CA6",
        "badge": "moderate",
    },
    {
...
def render(data, skim_mode):
    st.markdown("## Chapter 10 — Segment-Level Cashback Policy")
